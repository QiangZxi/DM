...
def load_clip_to_cpu(cfg):
    ...
    design_details = {"trainer": 'MaPLe',
                      ...
                      "tsa_opt":cfg.TRAINER.tsa_opt,
                      "tsa_ad_type":cfg.TRAINER.tsa_ad_type,
                      "tsa_ad_form":cfg.TRAINER.tsa_ad_form}
...
class CustomCLIP(nn.Module):
    def __init__(self, 
                 ...
                 clip_model):
        super().__init__()
        self.prompt_learner = prompt_learner(cfg, classnames, clip_model)
...
class MaPLe(TrainerX):
    ...
    def build_custom_clip(self, cfg, classnames, clip_model):
        self.model = CustomCLIP(cfg, MultiModalPromptLearner, classnames, clip_model)#BasePromptLearner
@TRAINER_REGISTRY.register()
class PMaPLe(MaPLe):
    def build_custom_clip(self, cfg, classnames, clip_model):
        self.model = CustomCLIP(cfg, ProgressivePromptLearner, classnames, clip_model)


@TRAINER_REGISTRY.register()
class BMaPLe(MaPLe):
    def build_custom_clip(self, cfg, classnames, clip_model):
        self.model = CustomCLIP(cfg, BiPromptLearner, classnames, clip_model)
